...
The next stage of this work is to evaluate the system using Google Street View images. These images contain challenges such as haze, shadows, foreground objects, and changing lighting conditions that are difficult to reproduce synthetically.
